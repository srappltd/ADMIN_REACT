        ...
        <form className='w-full p-5'>
          <div className='grid md:grid-cols-3 grid-cols-1 gap-5 items-start'>
            <div className='w-full'>
                ...
                <input type="text" placeholder='New Coupon' className='border w-full py-2 dark:bg-black dark:border-zinc-700 text-sm rounded-sm px-3' />
            </div>
            <div className='w-full'>
                ...
                <input type="text" placeholder='Ex: SRAPPLTD2018' className='border w-full py-2 dark:bg-black dark:border-zinc-700 text-sm rounded-sm px-3' />
            </div>
            <div className='w-full'>
                <h1 className='text-sm mb-1'>Limit For Same User</h1>
                <input type="text" placeholder='Ex: 10' className='border w-full py-2 dark:bg-black dark:border-zinc-700 text-sm rounded-sm px-3' />
            </div>
            <div className='w-full'>
            ...
            <div className='w-full'>
                ...
                <input type="text" placeholder='Ex: 0' className='border w-full py-2 dark:bg-black dark:border-zinc-700 text-sm rounded-sm px-3' />
            </div>
            <div className='w-full'>
            ...
            <div className='w-full'>
                ...
                <input type="date" placeholder='Ex: 0' className='border w-full py-2 dark:bg-black dark:border-zinc-700 text-sm rounded-sm px-3' />
            </div>
            <div className='w-full'>
