          ...
          <table className='md:w-full w-[1100px] h-[20px]'>
              ...
              <tbody>
                <tr className='w-full h-16 grid grid-cols-8 gap-3 py-2 items-center text-sm'>
                  ...
                  <td className='pl-3 text-zinc-600 dark:text-zinc-200 font-medium text-xs'>07 Nov 2023 <br />06:59 PM</td>
                  ...
                  <td className='pl-3 text-zinc-600 dark:text-zinc-200'>136.00$</td>
