        ...
        <form className='w-full p-5'>
          <div className='w-full grid md:grid-cols-2 grid-cols-1 gap-5'>
            <div className='w-full'>
              ...
              <input type="text" placeholder='New Category' className='border dark:bg-black dark:border-zinc-700 outline-none w-full py-2 text-sm rounded-sm px-3' />
            </div>
            <div className='w-full'>
              <h1 className='text-sm mb-1'>Main Category*</h1>
              <select name="" className='w-full p-2 border dark:bg-black dark:border-zinc-700 text-sm outline-none' id="">
