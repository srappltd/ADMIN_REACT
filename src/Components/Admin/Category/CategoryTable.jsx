          ...
          <table className='md:w-full w-[700px] h-[20px] overflow-x-auto'>
              ...
              <tbody>
                <tr className='w-full h-16 grid grid-cols-6 gap-3 py-2 items-center text-sm'>
                  ...
                  <td className='pl-3 flex items-center'><img src="https://efood-admin.6amtech.com/storage/app/public/category/2021-02-26-603892f899576.png" className='w-10' alt="" /></td>
