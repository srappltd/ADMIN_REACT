...
const ThirdBox = () => {
    return (
        <div className='w-full border dark:border-zinc-700 rounded-md px-3 pb-3'>
            <div className='flex justify-between items-center py-3 border-b dark:border-zinc-700'>
            ...
            <div className='w-full flex items-center justify-between p-3 bg-[#F8F9FB] dark:bg-zinc-950 dark:border-zinc-700 rounded mt-2'>
