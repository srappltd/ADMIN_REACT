  ...
  return (
    <div className='w-full flex-shrink-0 py-3 overflow-x-auto'>
          <table className='xl:w-full w-[900px] h-[20px] overflow-x-auto'>
              <thead className='w-full grid grid-cols-8 gap-3 py-2 border-y dark:border-zinc-700 text-sm'>
              ...
              <tbody>
                <tr className='w-full h-16 grid grid-cols-8 gap-3 py-2 items-center text-sm'>
                  ...
                  <td className='pl-3 text-zinc-600 dark:text-zinc-300'>Ice Cream</td>
                  <td className='pl-3 text-zinc-600 dark:text-zinc-300'>300.00$</td>
                  <td className='pl-3 text-zinc-600 dark:text-zinc-300'>20</td>
