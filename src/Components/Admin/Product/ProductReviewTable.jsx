          ...
          <table className='xl:w-full w-[900px] h-[20px] overflow-x-auto'>
              ...
              <tbody>
                <tr className='w-full h-16 grid grid-cols-6 gap-3 py-2 items-center text-sm'>
                  ...
                  <td className='pl-3 text-zinc-600 dark:text-zinc-300 text-xs font-medium'>Abhay Gautam <br />+91 62*********</td>
                  <td className='pl-3 text-zinc-600 dark:text-zinc-300'>The food is always goo</td>
