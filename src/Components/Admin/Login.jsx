            ...
            <div>
                ...
                <form action="" className='w-full mt-10'>
                    <div className='flex flex-col text-sm font-medium'>
                        ...
                        <input type="text" placeholder='Email@gmail.com' className='py-3 font-normal px-5 border rounded text-sm mt-1' />
                    </div>
                    <div className='flex flex-col text-sm font-medium mt-5'>
                        <label htmlFor="">Password</label>
                        <input type="text" placeholder='8+ characters required' className='py-3 font-normal px-5 border rounded text-sm mt-1' />
                    </div>
