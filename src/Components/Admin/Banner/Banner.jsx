        ...
        <form className='w-full p-5'>
          ...
          <div className='w-full'>
            <div>
              ...
              <input type="text" placeholder='New Banner' className='dark:bg-black dark:border-zinc-700 border w-full py-2 text-sm rounded-sm px-3' />
            </div>
            <div>
              <h1 className='text-sm mb-1 mt-4'>Category (EN)</h1>
              <select type="text" placeholder='New Banner' className='dark:bg-black dark:border-zinc-700 border w-full py-2 text-sm rounded-sm px-3'>
            ...
            <div className='w-full'>
              ...
              <div onClick={selectBannerBtn} className='w-full border dark:bg-black dark:border-zinc-700 rounded mt-2 flex text-sm font-medium cursor-pointer'>
                <input ref={bannrInput} onChange={bannerInputChange} type="file" hidden className='bannerInput dark:bg-black dark:border-zinc-700 w-full py-2 border'/>
